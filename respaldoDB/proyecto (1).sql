...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-06-2023 a las 16:26:29
...
('19982099-0', 'Felipe', 'Gonzalez', 'felipe@gmail.com', NULL, NULL);
...
(5, '2023_06_08_034938_create_estudiantes_table', 2),
(6, '2023_06_08_035510_create_propuestas_table', 2),
(7, '2023_06_08_040802_create_profesor_propuestas_table', 2),
(8, '2023_06_08_043345_create_profesores_table', 2);
...
('10000000-0', 'DAGOBERTO', 'CABRERA', NULL, NULL);
...
INSERT INTO `propuestas` (`id`, `fecha`, `documento`, `estado`, `estudiante_rut`, `created_at`, `updated_at`) VALUES
(555, '2023-06-16', 'uploads/kO8PTWnAQrC9vr9xxKcfLQzfc9bQh7LMAXWDJ50D.pdf', NULL, '19982099-0', NULL, NULL);
...
--
ALTER TABLE `propuestas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11112223;
